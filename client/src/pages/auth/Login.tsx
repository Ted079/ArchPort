  ...
  return (
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl mt-15">
      ...
      >
        ...
        <a
          href="#"
          className=" flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border border-gray-200 rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
        >
        ...
        <div className="flex items-center justify-between mt-4">
          <span className="w-1/5 border-b border-gray-200 dark:border-gray-600 lg:w-1/4"></span>
          ...
          <span className="w-1/5 border-b border-gray-200 dark:border-gray-400 lg:w-1/4"></span>
        </div>
        ...
        <div className="flex items-center justify-between mt-4">
          <span className="w-1/5 border-b border-gray-200 dark:border-gray-600 md:w-1/4"></span>
